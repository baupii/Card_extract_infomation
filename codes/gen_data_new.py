...
path_dic_img = "/home/lam/bau/CCCD/detect4point/yolo/dataset_new/images/train/"
path_dic_lb = "/home/lam/bau/CCCD/detect4point/yolo/dataset_new/labels/train/"

path_dic_img2 = "/home/lam/bau/CCCD/detect4point/yolo/dataset_new/images/val/"
path_dic_lb2 = "/home/lam/bau/CCCD/detect4point/yolo/dataset_new/labels/val/"
...
# path_dic_img = "C:/Users/ADMIN/Desktop/Thay_Lam/CCCD/imgs/output4/images/train/"
# path_dic_lb = "C:/Users/ADMIN/Desktop/Thay_Lam/CCCD/imgs/output4/labels/train/"

# path_dic_img2 = "C:/Users/ADMIN/Desktop/Thay_Lam/CCCD/imgs/output4/images/val/"
# path_dic_lb2 = "C:/Users/ADMIN/Desktop/Thay_Lam/CCCD/imgs/output4/labels/val/"
a = 0
...
#        add border
        ...
        if a < 12000:
            ...
            if a < 2500:
                ...
                # path_save1 = "/home/lam/bau/CCCD/detect4point/yolo/dataset_new/images/train/" + fi + "_1.jpg"
                # file_path = '/home/lam/bau/CCCD/detect4point/yolo/dataset_new/labels/train/' + fi + '_1.txt'
                path_save1 = path_dic_img + fi + "_1.jpg"
                file_path = path_dic_lb + fi + '_1.txt'
                ...
                path_save1 = path_dic_img + fi + "_2.jpg"
                file_path = path_dic_lb + fi + '_2.txt'
                cv2.imwrite(path_save1, out_new1)
                ...
                path_save1 = path_dic_img + fi + "_3.jpg"
                file_path = path_dic_lb + fi + '_3.txt'
                cv2.imwrite(path_save1, out_new1)
                ...
                path_save1 = path_dic_img + fi + "_4.jpg"
                file_path = path_dic_lb + fi + '_4.txt'
                cv2.imwrite(path_save1, out_new1)
                ...
                path_save1 = path_dic_img2 + fi + ".jpg"
                file_path = path_dic_lb2 + fi + '.txt'
                cv2.imwrite(path_save1, out_new1)
            ...
            if a >= 12000 and a < 14000:
                fi = str(a)
                path_save1 = path_dic_img + fi + "_5.jpg"
                file_path = path_dic_lb + fi + '_5.txt'
                cv2.imwrite(path_save1, bg)
