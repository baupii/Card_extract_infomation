...
path_bg = "/home/lam/bau/CCCD/detect4point/dataset/bg2/*"
...
#        add border
        ...
        if a < 10000:
            ...
            path_save1 = "/home/lam/bau/CCCD/detect4point/yolo/dataset1/images/train/" + fi + "_6.jpg"
            file_path = '/home/lam/bau/CCCD/detect4point/yolo/dataset1/labels/train/' + fi + '_6.txt'
            cv2.imwrite(path_save1, bg)
            
            
        else:
            fi = str(a)
            path_save1 = "/home/lam/bau/CCCD/detect4point/yolo/dataset1/images/val/" + fi + "_7.jpg"
            file_path = '/home/lam/bau/CCCD/detect4point/yolo/dataset1/labels/val/' + fi + '_7.txt'
            cv2.imwrite(path_save1, bg)
        
        h, w, _ = bg.shape
        tl, tr, br, bl, canny = preprocess2(black_bg)
