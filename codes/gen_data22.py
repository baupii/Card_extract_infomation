...
#     flexible = np.random.uniform(0.98,1.02)
    input_pts = np.float32([[w*0.05, h*0.05],[w, 0],[w, h],[w*0.05, h]])
...
#     flexible = np.random.uniform(0.98,1.02)
    input_pts = np.float32([[0, 0],[w*0.95, h*0.05],[w*0.95, h],[0, h]])
    output_pts = np.float32([[0, 0], [w, 0], [w, h], [0, h]])
    M = cv2.getPerspectiveTransform(input_pts,output_pts)
    out1 = cv2.warpPerspective(out_bg.copy(),M,(w, h),flags=cv2.INTER_LINEAR)
    out2 = cv2.warpPerspective(out_black_bg.copy(),M,(w, h),flags=cv2.INTER_LINEAR)
...
#     flexible = np.random.uniform(0.98,1.02)
    input_pts = np.float32([[w*0.05, 0],[w, 0],[w, h],[w*0.05, h*0.95]])
    output_pts = np.float32([[0, 0], [w, 0], [w, h], [0, h]])
    M = cv2.getPerspectiveTransform(input_pts,output_pts)
    out1 = cv2.warpPerspective(out_bg.copy(),M,(w, h),flags=cv2.INTER_LINEAR)
    out2 = cv2.warpPerspective(out_black_bg.copy(),M,(w, h),flags=cv2.INTER_LINEAR)
...
#     flexible = np.random.uniform(0.98,1.02)
    input_pts = np.float32([[0, 0],[w*0.95, 0],[w*0.95, h*0.95],[0, h]])
    output_pts = np.float32([[0, 0], [w, 0], [w, h], [0, h]])
    M = cv2.getPerspectiveTransform(input_pts,output_pts)
    out1 = cv2.warpPerspective(out_bg.copy(),M,(w, h),flags=cv2.INTER_LINEAR)
    out2 = cv2.warpPerspective(out_black_bg.copy(),M,(w, h),flags=cv2.INTER_LINEAR)
...
#        add border
        ...
        #resize card
        width_rand_ratio = np.random.uniform(0.5, 0.80)
        height_rand_ratio = np.random.uniform(0.5, 0.80)
        if w < h:
        ...
        check = True
        while (y1+h_) + 20 >= h or (x1+w_) + 20>= w:
            x1 = np.random.randint(x_min, x_max)
            y1 = np.random.randint(y_min, y_max)
        ...
        if a < 5000:
            ...
            if not os.path.exists('train'):
                os.makedirs('train')
            path_save1 = path_save_img_train + fi + "_1.jpg"
            file_path = path_save_label_train + fi + '_1.txt'
            print(path_save1)
            if a % 10 == 0:
                out1 = add_bright(out1)
            out1 = add_border_white2(out1)
            ...
            path_save1 = path_save_img_train + fi + "_2.jpg"
            file_path = path_save_label_train + fi + '_2.txt'
            # path_save2 = "abc/" + fi + "_4.jpg"
            print(path_save1)
            if a % 10 == 0:
                out1 = add_bright(out1)
            out1 = add_border_white2(out1)
            ...
            path_save1 = path_save_img_train + fi + "_3.jpg"
            file_path = path_save_label_train + fi + '_3.txt'
            # path_save2 = "abc/" + fi + "_4.jpg"
            print(path_save1)
            if a % 10 == 0:
                out1 = add_bright(out1)
            ...
            path_save1 = path_save_img_train + fi + "_4.jpg"
            file_path = path_save_label_train + fi + '_4.txt'
            # path_save2 = "abc/" + fi + "_4.jpg"
            print(path_save1)
            if a % 10 == 0:
                out1 = add_bright(out1)
        ...
        #val
            ...
            path_save1 = path_save_img_val + fi + "_val.jpg"
            file_path = path_save_label_val + fi + '_val.txt'
            print(path_save1)
            if a % 10 == 0:
                out1 = add_bright(out1)
            # add boder to out1
